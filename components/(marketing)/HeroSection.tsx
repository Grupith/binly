...
const HeroSection = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center pt-28 py-28 bg-gradient-to-br from-sky-100 via-gray-50 to-gray-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-center px-6">
      ...
      <div className="flex gap-4 flex-wrap justify-center pt-0 pb-6">
        <Button
          variant="default"
